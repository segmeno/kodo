...
@CustomSql(selectQuery="""
		SELECT u.id AS CustomElementID, u.Name AS customName, 3 AS customAmount,
		...
		""", knownColumnNames= {"CustomElementID","Name","customName","customAmount"})
